...
"""
    ...
    def test_simple_header(self):
        ...
        self.assertEqual(header_text, "Hello")
...
# and only the last one is header"""
        header_text = extract_title(md)
        self.assertEqual(header_text, "and only the last one is header")

    def test_absent_header(self):
        md = "This md doesn't contain any headers"
