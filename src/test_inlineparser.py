...
class TestSplitDelimeter(unittest.TestCase) :
	...
	def test_single_delimeter(self) :
		...
		self.assertListEqual(new_nodes, [TextNode("This is an ", TextType.TEXT), TextNode("italic", TextType.ITALIC), TextNode(" node", TextType.TEXT)])
	...
	def test_multiple_matching_delimeters(self) :
		...
		self.assertListEqual(new_nodes, [TextNode("This node contains ", TextType.TEXT), TextNode("first code", TextType.CODE), TextNode(" and ", TextType.TEXT), TextNode("second code", TextType.CODE), TextNode(" nodes", TextType.TEXT)])

	def test_different_delimeters(self) :
		node = TextNode("This node contains `code` and _italic_ nodes", TextType.TEXT)
		new_nodes = split_nodes_delimeter([node], "_", TextType.ITALIC)
		self.assertListEqual(new_nodes, [TextNode("This node contains `code` and ", TextType.TEXT), TextNode("italic", TextType.ITALIC), TextNode(" nodes", TextType.TEXT)])
	...
	def test_multiple_nodes(self) :
		...
		self.assertEqual(new_nodes, [TextNode("This is the first ", TextType.TEXT), TextNode("code", TextType.CODE), TextNode(" node", TextType.TEXT), TextNode("And this is a second node of ", TextType.TEXT), TextNode("code", TextType.CODE)])
